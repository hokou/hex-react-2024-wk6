...
function App() {
  ...
  const addCarItem = async (product_id, qty) => {
    setIsLoading(true);
    try {
              ...
              <tr key={product.id}>
                ...
                <td>
                  <div className="btn-group btn-group-sm">
                    ...
                    <button 
                      disabled={isLoading}
                      onClick={() => addCarItem(product.id, 1)} type="button" className="btn btn-outline-danger d-flex align-items-center">
                      加到購物車
                      {isLoading && (
                        <ReactLoading
                          type={"spin"}
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button
                  disabled={isLoading}
                  onClick={() => addCarItem(tempProduct.id, qtySelect)} type="button" className="btn btn-primary d-flex align-items-center gap-2">
                  加入購物車
                  {isLoading && (
                    <ReactLoading
                      type={"spin"}
